...
public class TyProductController {
    ...
    @PostMapping("/tyProduct.controller")
    public String handlerMethod(Locale locale, Model model, String prodaction, ProductBean bean,
        ...
        if ("Insert".equals(prodaction) || "Update".equals(prodaction) || "Delete".equals(prodaction)) {
            if (bean == null || bean.getId() == null) {
                errors.put("id",
                        messageSource.getMessage("product.required.id", new String[] { prodaction }, locale));
            }
        }
